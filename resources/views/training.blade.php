        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
                <div class="DesignHead aboutHead">
                    ...
                    <h2>  <span>MicrTech NA Inc</span></h2>
                      </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="example"> <img src="./images/ali.jpg" alt="ali" />
                    <div class="example-text">
                        <p><i class="fa fa-quote-left" aria-hidden="true"></i><br>ট্রেনিং এর প্রতিটা মুহুর্ত আমার কষ্ট লাগত
                            <br> কিন্তু আমি পণ করেছিলাম
                            <br> আর নিজের মনকে বলেছিলাম
                            <br>এখন কর যাতে বাকি সারা জীবন
                            <br>চ্যাম্পিয়ন হয়ে বেচে থাক<i class="fa fa-quote-right" aria-hidden="true"></i>
                            <br>- Muhammmed Ali</p>
                    </div>
                    <h4>অলসতাকে ধরাশয়ী কর আমাদের গাইডলাইন যথাযথভাবে follow করলে USA তে IT Job ১০০% নিশ্চত </h4> </div>
            </div>
        </div>
...
<div class="row about-course-area">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="experienceMic custom"> <img src="./images/about1.jpg" alt="Software Testing" />
                    ...
                    <h3>Barakat Chowdhury</h3>
                    <h4>Sofware Engineer</h4>
                    <p>Oracle Certified Professional
                        <br> BSc in computer science and Engg, MS USA</p>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="experienceMic custom"> <img src="./images/about1.jpg" alt="Software Testing" />
