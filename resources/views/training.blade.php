        ...
        <div class="main-example">
            <div class="example">
                ...
                <div class="example-text">
                    <p><i>&#10077;</i> ট্রেনিং এর প্রতিটা মুহুর্ত আমার কষ্ট লাগত কিন্তু আমি পণ করেছিলাম আর নিজের মনকে বলেছিলাম এখন কষ্ট কর যাতে বাকি সারা জীবন চ্যাম্পিয়ন হয়ে বেঁচে থাক <i class="left-qoute"> &#x275E;</i><br>
                        <span>- Muhammmed Ali</span> </p>
                </div>
            </div>
            <div class="sussget-text">
                <h4> অলসতাকে ধরাশায়ী করে আমাদের গাইডলাইন যথাযথভাবে follow করলে USA তে IT Job ১০০% নিশ্চিত ।</h4>
            </div>
        </div>
    </div>
</div>
