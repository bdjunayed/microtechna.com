                    ...
                    <div class="example">
                        <div class="example-text">
                            <p><i class="fa fa-quote-left" aria-hidden="true"></i>
                                ...
                                <br>চ্যাম্পিয়ন হয়ে বেঁচে থাক <i class="fa fa-quote-right" aria-hidden="true"></i>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="experienceMic messanger-text">
                    <p>আপনার পরিচিত কেও কি Familly Migration(I-130) এ আমিরিকাতে আসবে ? আমিরিকাতে আসার আগে বাংলাদেশ থেকে উপযুক্ত ট্রেনিং নিয়ে সরাসরি আইটি জব শুরু করতে আমরা সাহায্য করে থাকি ।
                        <br> বাংলাদেশ থেকে আমেরিকায় Familly migration or Other Visa নিয়ে আসার আগে তিন/ছয় মাসের কোর্স করে আসুন কারন এই কোর্স আমেরিকাতে করতে কয়েকগুন খরচ করেও এই ধরনের সুবিধা পাবেন না । মোটকথা আপনার সময় বের করাটা অসম্ভব হবে এবং আমেরিকার কোন ট্রেনিং সেন্টার আপনাকে এভাবে সার্ভিস দিবে না । আমাদের ২০ বছরের অবিজ্ঞতার আলোকে সাজানো এই প্রথম ও একমাত্র ব্যতিক্রমধর্মী ট্রেনিং সেন্টার আপনাদের সেবায় সদা প্রস্তুত । আমেরিকাতে যারা বসবাস করছেন তারাও তিন মাসের জন্য বাংলাদেশে ভিজিট করে আমাদের এই সেবা গ্রহন করতে পারেন ।
                        <br>
...
<!--.Contact-us-area-->
<div class="contact-us experienceMic">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 col-md-4">
                <div class="single-content custom-center">
                    <div class="logo"> <a href="{{ url('/') }}">MicroTech NA, Inc.</a> </div>
