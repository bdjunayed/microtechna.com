...
<div class="container-training">
    <div class="tr-heading">
        <h1 class="bn">অভিজ্ঞ আমেরিকান আইটি প্রফেশনাল দ্বারা পরিচালিত বাংলাদেশে এই প্রথম ও একমাত্র ব্যতিক্রমধর্মী ট্রেনিং সেন্টার</h1>
    </div>
    <div class="tr-content">
        <div class="heading">
            <h2 class="bn">প্রতিদিনের ক্লাসের সিলেবাস প্রফেশনাল আইটি টিচারদের দ্বারা হাতে-কলমে প্রতিদিন বার ঘন্টা করে ছয় মাস বার বার রিয়েল লাইফ অনুশীলনের মাধ্যমে বুঝিয়ে মুখস্ত করানোর সাথে আইটি জবের ১০০% নিশ্চয়তা </h2>
        </div>
        <div class="main-example">
            <div class="example">
                ...
                <div class="example-text">
                    <p class="bn"><i>&#10077;</i> ট্রেনিং এর প্রতিটা মুহুর্ত আমার কষ্ট লাগত কিন্তু আমি পণ করেছিলাম আর নিজের মনকে বলেছিলাম এখন কষ্ট কর যাতে বাকি সারা জীবন চ্যাম্পিয়ন হয়ে বেঁচে থাক <i class="left-qoute"> &#x275E;</i><br>
                        <span>- Muhammmed Ali</span> </p>
                </div>
            </div>
            <div class="sussget-text">
                <h4 class="bn"> অলসতাকে ধরাশায়ী করে আমাদের গাইডলাইন যথাযথভাবে follow করলে USA তে IT Job ১০০% নিশ্চিত ।</h4>
            </div>
        </div>
    </div>
</div>
<!-- About course start here-->
<div class="training-details-section bn">
    <div class="about-course-area">
        <div class="what-are-you-get">
            ...
            <div class="bollet">
                ...
                <li><b>ফ্রি থাকা ও উন্নতমানের খাবারের সুব্যবস্থা (আবাসিক)</b>
                    <p>যাতে করে স্টুডেন্টরা সম্পুর্ণভাবে ট্রেনিং এ মনোনিবেশ করতে পারে ।</p>
                </li>
                ...
                <li><b> ফ্রি বেসিক কম্পিউটার কোর্স</b>
                    <p>কম্পিউটার ব্যাকগ্রাউন্ড নাই এমন স্টুডেন্টদের আইটি কোর্স শুরুর আগেই কম্পিউটার অপারেটিং এ দক্ষ করে তোলা।</p>
                </li>
...
<div class="training-section">
    ...
    <div class="single-course">
        ...
        <div class="custom-enroll"> <a href="https://form.jotform.me/72975839174473"><span>Enroll Now</span></a>
        <a>Duration: 3 or 6 months</a>
        </div>
    </div>

    <div class="single-course">
        <img src="./images/sqlserverDBA.jpg" alt="Software Testing" />
        <h2>SQL Server DBA</h2>
    ...
    <div class="single-course">
        ...
        <h2>Red Hat Certified Engineer - RHCE</h2>
