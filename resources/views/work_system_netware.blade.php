...
@section('content')
<section class="ServiceFourMenu workwebsitesystem">
...
<section class="ChreeSec workwebsec">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="SingleCheery">
                    ...
                    <a href="http://systemnetware.com" class="downloagBtn pull-right">Visit</a>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 pull-right">
                <div class="SingleCheery SingleCheeryAnother">
                    <h2>Our Approach to System Netware</h2>
                    ...
                    <a href="http://www.banglatyping.com/download-bangla-software/" class="downloagBtn AnotherdownBtn pull-right">downloag APP</a>
                </div>
            </div>
        </div>
    </div>
