        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="SpBanerSingle">
                    <h2>Software Performance Testing</h2>
                ...
                <div class="SPerForMainLeft">
                    <div class="SingleCmFooter PerForLeftHeading">    
                        ...
                        <div class="FSerMenu PerForLeft">
                            <h1><a href="{{ url('/mobile_app') }}l">App developments</a></h1>
                    ...
                    <div class="SingleCmFooter PerForLeftHeading">    
                        <h2>Usefull links</h2>
                        <div class="FSerMenu PerForLeft">
                            <h1><a href="http://banglatyping.com/">Bangla Software</a></h1>
                            <h1><a href="http://matesglobal.com/">Mates Global</a></h1>
                            <h1><a href="http://life110volts.com/">Life 110Volts</a></h1>
                            <h1><a href="http://www.toptenoftheworld.com/">Top Ten of the World</a></h1>
                        </div>
                    </div>
                    <div class="SingleCmFooter PerForLeftHeading">    
                        <a href="{{ url('/work_with_us') }}" class="SperForLeftQute">get a quote</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-9">
